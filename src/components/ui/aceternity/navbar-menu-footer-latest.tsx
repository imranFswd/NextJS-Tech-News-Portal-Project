...
export const MenuItem = ({
  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative  hover:underline underline-offset-4 capitalize transition-all duration-300">
      <motion.p
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-sm border border-transparent   dark:border-white/[0.2]   flex flex-col justify-center  space-x-0 transition-all duration-300 "
    >
      {children}
    </nav>
  );
